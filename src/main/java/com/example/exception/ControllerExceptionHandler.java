...
/**Spring supports exception handling by a global Exception Handler
(@ExceptionHandler) with Controller Advice (@RestControllerAdvice). 

The @RestControllerAdvice annotation is a specialization of @Component annotation so
that it is auto-detected via classpath scanning. It is a kind of interceptor
that surrounds the logic in our Controllers and allows us to apply some common
logic to them.
...
public class ControllerExceptionHandler {
    ...
    public ErrorMessage resourceNotFoundException(ResourceNotFoundException
